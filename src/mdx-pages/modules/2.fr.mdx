...
* Copiez le fichier `jsconfig.json` et `src/index.js` (ou `jsconfig.json`, `src/main.js` et `src/index.css` si vous utilisez vite) depuis le dossier de l'exercice du module précédent.
