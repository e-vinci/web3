...
- b) [Exercice 1 : Votes prédéfinis](#b)
...
Après la liste, un champ texte et un bouton **Add** permet d'ajouter une opinion (avec un score initial de 1).
...
Créer un contexte **themeContext**, celui-ci permet de **setDarkTheme()**, et **setLightTheme()**, **toggleTheme()**, ainsi que **getCurrentThemeDetails()**.
