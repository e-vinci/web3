...
- b) [Exercice 5.1 : Votes prédéfinis](#b)
- c) [Exercice 5.2 : Votes d'opinions](#c)
- d) [Résumé](#d)
- e) [🍬 Exercice 5.3 : pour s'entraîner encore](#e)
- f) [🍬 Exercice 5.4 : un joli contexte](#f)
- g) [Solution des exercices](#g)
...
NB : optionnellement, il est possible d'utiliser des hooks customs qui encapsulent un usage limité du **useContext**.
...
### a.3.1) Etape 1 : Créer un fichier contexte  
...
### a.3.2) Etape 2 : Définir le state et ses fonctions de manipulation du state
...
### a.3.3) Etape 3 : Broadcaster le contexte à l'aide du Provider
...
Attention, à cette étape-ci, vous devez vous assurer que le point d'entrée de votre programme, `index.js`, fait bien appel à **AppLoader** et plus à **App**. Votre `index.js` ressemblera à cela :
``` js
...
- Documentation générale de React sur les contextes : [Context](https://reactjs.org/docs/context.html) [[R.6]](/references/#r6)
- Documentation plus spécifique sur le hook useContext : [useContext](https://reactjs.org/docs/hooks-reference.html#usecontext) [[R.6]](/references/#r6)
- Article assez complet et récent sur l'intérêt et l'usage des contextes : [How to Use React’s Context API and useContext() Hooks Effectively](https://medium.com/better-programming/how-to-use-reacts-context-api-and-usecontext-hooks-effectively-ed98ad9343b6) [[R.8]](/references/#r8)
...
# <a id="b"></a>b) Exercice 5.1 : Votes prédéfinis
...
Pour votre exercice, veuillez créer une nouvelle application React dans le dossier **/exercises/module5/5.1** de votre repo local.  
...
# <a id="e"></a> e) 🍬 Exercice 5.3 : pour s'entraîner encore
...
# <a id="f"></a> f) 🍬 Exercice 5.4 : un joli contexte
Dans le dernier bonus du module précédent, une application permettant de gérer des numéros de téléphone a été implémentée. 

Nous vous proposons de faire un refactor de la solution de cette exercice en utilisant les contextes pour gérer un état global de votre application. Vous pouvez télécharger la solution ici : <LinkFile name="module4-main-version avec bonus.zip" target="_blank" download>Module4 - Version avec bonus</LinkFile>.

# <a id="g"></a> g) 🍬 Solution des exercices
Une solution pour les exercices de ce module se trouvent ici : [module5](https://gitlab.vinci.be/6i3-web3/2022-2023/module5.git).
