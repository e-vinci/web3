...
Attention, à cette étape-ci, vous devez vous assurer que le point d'entrée de votre programme, **`main.js`** (application Vite), fait bien appel à **AppLoader** et plus à **App**. Votre **`main.js`** ressemblera à cela :
``` js
...
Une solution pour les exercices de ce module se trouvent ici : [module5](https://gitlab.vinci.be/6i3-web3/2023-2024/module5.git).
